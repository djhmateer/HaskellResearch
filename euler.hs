...
-- Euler 1 using Pattern Matching with Guards
-- Guards should work
div3Or5 :: Integral a => a -> Bool
div3Or5 x
    | x `mod` 3 == 0 = True
    | x `mod` 5 == 0 = True
    | otherwise = False
...
-- checker for 1..10, outputting a Tuple
bc = [(x,div3Or5 x) | x <- [1..15]]

bd = sum [x | x <- [1..999], div3Or5 x]
--233168
